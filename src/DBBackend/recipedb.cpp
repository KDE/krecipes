...
RecipeDB::RecipeDB(QString host, QString user, QString pass, QString DBname,bool init)
{
...
void RecipeDB::loadRecipe(Recipe *recipe,int recipeID)
{
...
void RecipeDB::loadIngredients(ElementList *list)
{
list->clear();
...
void RecipeDB::loadPossibleUnits(int ingredientID, ElementList *list)
{
list->clear();
...
void RecipeDB::saveRecipe(Recipe *recipe)
{
...
void RecipeDB::loadRecipeList(ElementList *list)
{
list->clear();
...
void RecipeDB::removeRecipe(int id)
{
QString command;
...
void RecipeDB::createNewIngredient(QString ingredientName)
{
QString command;
...
void RecipeDB::modIngredient(int ingredientID, QString newLabel)
{
QString command;
...
void RecipeDB::addUnitToIngredient(int ingredientID,int unitID)
{
QString command;
...
void RecipeDB::loadUnits(ElementList *list)
{
list->clear();
...
void RecipeDB::removeUnitFromIngredient(int ingredientID, int unitID)
{
QString command;
...
void RecipeDB::findUseOf_Ing_Unit_InRecipes(ElementList *results, int ingredientID, int unitID)
{
...
void RecipeDB::findUseOfIngInRecipes(ElementList *results,int ingredientID)
{
...
void RecipeDB::removeIngredient(int ingredientID)
{
QString command;
...
void RecipeDB::initializeDB(void)
{
// Select the database
...
void RecipeDB::addProperty(QString &name, QString &units)
{
QString command;
...
void RecipeDB::loadProperties(IngredientPropertyList *list,int ingredientID)
{
list->clear();
QString command;
bool usePerUnit;
...
void RecipeDB::changePropertyAmountToIngredient(int ingredientID,int propertyID,double amount,int per_units)
{
QString command;
...
void RecipeDB::addPropertyToIngredient(int ingredientID,int propertyID,double amount, int perUnitsID)
{
QString command;
...
void RecipeDB::removePropertyFromIngredient(int ingredientID, int propertyID, int perUnitID)
{
QString command;
...
void RecipeDB::removeProperty(int propertyID)
{
QString command;
...
void RecipeDB::removeUnit(int unitID)
{
QString command;
...
void RecipeDB::createNewUnit(QString &unitName)
{
QString command;
...
void RecipeDB::modUnit(int unitID, QString newLabel)
{
QString command;
...
void RecipeDB::findUseOf_Unit_InRecipes(ElementList *results, int unitID)
{
...
void RecipeDB::findUseOf_Unit_InProperties(ElementList *results, int unitID)
{
...
void RecipeDB::loadUnitRatios(UnitRatioList *ratioList)
{
ratioList->clear();
...
void RecipeDB::saveUnitRatio(const UnitRatio *ratio)
{
QString command;
...
double RecipeDB::unitRatio(int unitID1, int unitID2)
{
...
void RecipeDB::findIngredientUnitDependancies(int ingredientID,int unitID,ElementList *recipes,ElementList *ingredientInfo)
{
...
void RecipeDB::findIngredientDependancies(int ingredientID,ElementList *recipes)
{
...
void RecipeDB::findUnitDependancies(int unitID,ElementList *properties,ElementList *recipes)
{
...
void RecipeDB::loadElementList(ElementList *elList, QSqlQuery *query)
{
if ( query->isActive() ) {
                while ( query->next() ) {
		    Element el;
...
void RecipeDB::loadPropertyElementList(ElementList *elList, QSqlQuery *query)
{
if ( query->isActive() ) {
                while ( query->next() ) {
		    Element el;
...
QCString RecipeDB::escapeAndEncode(const QString &s)
{
QString s_escaped=s;
...
bool RecipeDB::ingredientContainsUnit(int ingredientID, int unitID)
{
...
bool RecipeDB::ingredientContainsProperty(int ingredientID, int propertyID, int perUnitsID)
{
...
QString RecipeDB::unitName(int unitID)
{
...
bool RecipeDB::checkIntegrity(void)
{
...
void RecipeDB::createTable(QString tableName)
{
...
void RecipeDB::splitCommands(QString& s,QStringList& sl)
{
sl=QStringList::split(QRegExp(";{1}(?!@)"),s);
}

void RecipeDB::portOldDatabases(float version)
{
...
float RecipeDB::databaseVersion(void)
{
...
void RecipeDB::loadRecipeCategories(int recipeID, ElementList *list)
{
...
void RecipeDB::createNewCategory(QString &categoryName)
{
QString command;
...
void RecipeDB::removeCategory(int categoryID)
{
QString command;
...
void RecipeDB::addCategoryToRecipe(int recipeID, int categoryID)
{
...
void RecipeDB::loadAuthors(ElementList *list)
{
list->clear();
...
void RecipeDB::loadRecipeAuthors(int recipeID, ElementList *list)
{
list->clear();
...
void RecipeDB::createNewAuthor(const QString &authorName)
{
QString command;
...
void RecipeDB::removeAuthor(int authorID)
{
QString command;
...
void RecipeDB::addAuthorToRecipe(int recipeID, int authorID)
{
...
int RecipeDB::findExistingUnitsByName(const QString& name,int ingredientID, ElementList *list)
{
QString command;
...
int RecipeDB::findExistingElementByName( const QString& name, const QString &element )
{
...
int RecipeDB::findExistingAuthorByName( const QString& name )
{
	return findExistingElementByName( name, "authors" );
}

int RecipeDB::findExistingCategoryByName( const QString& name )
{
	return findExistingElementByName( name, "categories" );
}

int RecipeDB::findExistingIngredientByName( const QString& name )
{
	return findExistingElementByName( name, "ingredients" );
}

int RecipeDB::findExistingUnitByName( const QString& name )
{
	return findExistingElementByName( name, "units" );
}

int RecipeDB::findExistingRecipeByName( const QString& name )
{
...
void RecipeDB::givePermissions(const QString &dbName,const QString &username, const QString &password, const QString &clientHost)
{
QString command;
...
QString RecipeDB::getUniqueRecipeTitle( const QString &recipe_title )
{
	//already is unique
...
QString RecipeDB::recipeTitle(int recipeID)
{
