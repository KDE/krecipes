...
private:
	...
	void readRecipemlIng( const QDomElement&, Ingredient *ing = 0, const QString &header = QString::null );
	...
	void readRecipemlRange( const QDomElement&, double &range, double &range_offset );
