...
public:
	...
	/* This method joins the names of the elements like join
	   but it escapes the names first, @param sep is not escaped */
	QString joinHtmlEscaped( const QString &sep ) const;
